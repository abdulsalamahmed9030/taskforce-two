...
export default function AboutOurOrganization() {
  ...
  >
    ...
    <p className="text-gray-700 leading-relaxed text-base font-open-sans md:text-justify">
      TASK FORCE INTERIOR (P) LTD. is led by seasoned professionals in civil engineering, interior design, and turnkey project management. We excel at analyzing spaces to create floor plans that maximize functionality, optimize flow, and make the best use of every square foot.
    </p>

    <p className="text-gray-700 leading-relaxed text-base font-open-sans md:text-justify">
      Over the years, we’ve delivered premium offices, showrooms, software centers, BPOs, and data centers. Our portfolio also includes striking atriums and precision ACP & glass cladding for multi-storey buildings across Hyderabad and other major cities.
    </p>

    <div className="grid grid-cols-2 gap-4 text-sm font-medium text-gray-800 font-open-sans">
      {[
        "80+ Hospital Projects",
