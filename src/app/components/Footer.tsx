...
export default function Footer() {
  ...
  <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
    ...
    {/* Popular Link */}
    <div>
      <h4 className="text-black text-2xl font-semibold mb-4">Popular Links</h4>
      <ul className="space-y-2 text-black">
        <li>❯ <Link href="/">Home</Link></li>
        <li>❯ <Link href="/aboutus">About Us</Link></li>
        <li>❯ <Link href="/services">Services</Link></li>
        <li>❯ <Link href="/gallery">Portfolio</Link></li>
        <li>❯ <Link href="/ourequipments">Manufacturing Plant</Link></li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="space-y-2 text-gray-800">
        <li>❯ <Link href="/contact" className="hover:text-yellow-700">Contact</Link></li>
        <li>❯ <Link href="/clients" className="hover:text-yellow-700">Our Clients</Link></li>
        <li>❯ <Link href="/faq" className="hover:text-yellow-700">FAQ</Link></li>
        <li>❯ <Link href="/csr" className="hover:text-yellow-700">CSR</Link></li>
        <li>❯ <Link href="/ourteam" className="hover:text-yellow-700">Our Team</Link></li>
      </ul>
    </div>
  </div>
